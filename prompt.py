system_prompt_for_relevant_links = """You are provided with a list of links found on a webpage. \
...
user_prompt_for_relevant_links += """please decide which of these are relevant web links for a brochure about the company, respond with the full https URL in JSON format. \
...
user_prompt_for_summary += """Here are the contents of its landing page and other relevant pages; use this information to build a short brochure of the company in markdown.\n"""
